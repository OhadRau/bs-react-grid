...
function layout(w, h, x, y, i, minW, maxW, minH, maxH, moved, $$static, isDraggable, isResizable, draggableHandle, _) {
  return {
          w: w,
          h: h,
          x: x,
...
function make(cols, containerWidth, margin, containerPadding, rowHeight, maxRows, isDraggable, draggableHandle, isResizable, $$static, useCSSTransforms, usePercentages, className, style, cancel, handle, x, y, w, h, minW, maxW, minH, maxH, i, onDrag, onDragStart, onDragStop, onResize, onResizeStart, onResizeStop) {
  var partial_arg = {
